        <div class="es17_bg template es20_balcony">
            <div class="container">
                ...
                <div class="es17_blockbg">
                    ...
                    <div class="phone">8 (917) 122-28-80</div>
                    ...
                    <p class="agreement ">Оставляя свои контактные данные, вы подтверждаете свое совершеннолетие, соглашаетесь на обработку персональных данных в соответствии с <a href="#legal-info" class="legal-info"  data-toggle="modal"  data-target="#legal-info">Правовой информацией</a></p>
                </div>
            </div>
        </div>
        <!-- /.es17_bg -->
