        <div class="template es2_balcons finishing_balconies_calc">
            ...
            <div class="text">"Остекление балконов" - компания,которая предлагает услуги по утеплению и отделке балконов и лоджий <?php echo get_option('my_city_v'); ?> уже более 10 лет! За это время нами было реализовано свыше 13 000 проектов. Высокий уровень качества продукции и отсутствие недочетов при монтаже являются визитной карточкой компании.</div>
            <!-- $$$$$$$ -->
            <!-- $$$$$$$ -->
            <!-- $$$$$$$ -->
