        <div class="template es2_balcons finishing_balconies_calc">
            ...
            <div class="h2">
                ...
                ЛУЧШИЕ ЦЕНЫ НА БАЛКОНЫ <?php echo get_option('my_city_v'); ?>
            </div>
            <div class="text">"Остекление балконов" - компания,которая предлагает услуги по утеплению и отделке балконов и лоджий <span class="gorod-v"><?php echo get_option('my_city_v'); ?></span> уже более 10 лет! За это время нами было реализовано свыше 13 000 проектов. Высокий уровень качества продукции и отсутствие недочетов при монтаже являются визитной карточкой компании.</div>
            <!-- $$$$$$$ -->
            <!-- $$$$$$$ -->
            <!-- $$$$$$$ -->
            ...
            <div class="calc_otdelka">						
                ...
                <div class="calc_otdelka__left">
                    <!--ОТДЕЛКА стен-->
                    <div class="yellow_plash_bg red-button"><div class="plash_line_4"><div></div></div><span>ОТДЕЛКА стен</span></div>
                    ...
                    <!--Тип остекления-->
                    <div class="yellow_plash_bg red-button"><div class="plash_line_2"><div></div></div><span>Тип остекления</span></div>
                    ...
                    <div class="yellow_plash_bg red-button"><div class="plash_line_3"><div></div></div><span>Внешняя отделка</span></div>
                ...
                <div class="calc_otdelka__right">
                    ...
                    <div class="yellow_plash_bg red-button"><div class="plash_line_1"><div></div></div><span>Крыша на балкон</span></div>
                    ...
                    <div class="yellow_plash_bg red-button"><div class="plash_line_5"><div></div></div><span>ШКАФ на балкон</span></div>
                    ...
                    <div class="yellow_plash_bg red-button"><div class="plash_line_6"><div></div></div><span>НАСТИЛ ПОЛА</span></div>
